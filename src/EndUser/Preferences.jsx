      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="flex justify-between mt-6">
          ...
          <button
            ...
            className={`flex items-center justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-yellow-500 hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ${
              (stage === 0 && files.length === 0) ||
              (stage === 2 &&
                (!preferences.paperType || !preferences.noofCopies)) ||
              stage === stages.length - 1
